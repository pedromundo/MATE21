  ...
  while (fscanf(file, "%s", buf) != EOF) {
    ...
    case 'K':
      ...
      case 'd':
        ...
        break;
      case 's':
        fscanf(file, "%f %f %f", &model->materials[nummaterials].specular[0],
    ...
    case 'v': /* v, vn, vt */
      ...
      case '\0': /* vertex */
        fscanf(file, "%f %f %f", &vertices[3 * numvertices + 0],
               &vertices[3 * numvertices + 1], &vertices[3 * numvertices + 2]);
        numvertices++;
        break;
      case 'n': /* normal */
        fscanf(file, "%f %f %f", &normals[3 * numnormals + 0],
               &normals[3 * numnormals + 1], &normals[3 * numnormals + 2]);
        numnormals++;
        break;
      case 't': /* texcoord */
